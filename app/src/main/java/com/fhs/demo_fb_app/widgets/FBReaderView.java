...
import com.fhs.demo_fb_app.apps.Reflow;
import com.fhs.demo_fb_app.apps.Storage;
import com.fhs.demo_fb_app.services.ImagesProvider;
...
import org.geometerplus.zlibrary.ui.android.aplicatii.romanesti.view.ZLAndroidWidget;
        ...
        if (app.getPopupById(SelectionPopup.ID) == null) {
            new SelectionPopup(app) {
                ...
                public void createControlPanel(Activity activity, RelativeLayout root) {
                    ...
                    View t = myWindow.findViewById(org.geometerplus.zlibrary.ui.android.aplicatii.romanesti.R.id.selection_panel_translate);
