...
public interface LibraryInterface extends android.os.IInterface
{
  ...
  public static class Default implements org.geometerplus.android.fbreader.libraryService.LibraryInterface
  {
    ...
    @Override public java.util.List<java.lang.String> deletedBookLabelUids(int limit, int page) throws android.os.RemoteException
    {
      return null;
    }
    @Override public void purgeBookLabels(java.util.List<java.lang.String> uids) throws android.os.RemoteException
    {
    }
    @Override public void deleteBookLabelByUuid(java.lang.String uuid) throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements org.geometerplus.android.fbreader.libraryService.LibraryInterface
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_storePosition:
        {
          ...
          _arg1 = _Parcel.readTypedObject(data, org.geometerplus.android.fbreader.libraryService.PositionWithTimestamp.CREATOR);
        ...
        case TRANSACTION_deletedBookLabelUids:
        {
          int _arg0;
          _arg0 = data.readInt();
          int _arg1;
          _arg1 = data.readInt();
          java.util.List<java.lang.String> _result = this.deletedBookLabelUids(_arg0, _arg1);
          reply.writeNoException();
          reply.writeStringList(_result);
          break;
        }
        case TRANSACTION_purgeBookLabels:
        {
          java.util.List<java.lang.String> _arg0;
          _arg0 = data.createStringArrayList();
          this.purgeBookLabels(_arg0);
          reply.writeNoException();
          break;
        }
        case TRANSACTION_deleteBookLabelByUuid:
        {
          java.lang.String _arg0;
          _arg0 = data.readString();
          this.deleteBookLabelByUuid(_arg0);
          reply.writeNoException();
          break;
        }
        default:
    ...
    private static class Proxy implements org.geometerplus.android.fbreader.libraryService.LibraryInterface
    {
      ...
      @Override public org.geometerplus.android.fbreader.libraryService.PositionWithTimestamp getStoredPosition(long bookId) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _reply.readException();
          _result = _Parcel.readTypedObject(_reply, org.geometerplus.android.fbreader.libraryService.PositionWithTimestamp.CREATOR);
        }
        finally {
          _reply.recycle();
          _data.recycle();
      ...
      @Override public java.util.List<java.lang.String> deletedBookLabelUids(int limit, int page) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _data.writeInt(page);
          boolean _status = mRemote.transact(Stub.TRANSACTION_deletedBookLabelUids, _data, _reply, 0);
          _reply.readException();
          _result = _reply.createStringArrayList();
        }
        finally {
      ...
      @Override public void purgeBookLabels(java.util.List<java.lang.String> uids) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeStringList(uids);
          boolean _status = mRemote.transact(Stub.TRANSACTION_purgeBookLabels, _data, _reply, 0);
          _reply.readException();
        }
        finally {
          _reply.recycle();
      ...
      @Override public void deleteBookLabelByUuid(java.lang.String uuid) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_deleteBookLabelByUuid, _data, _reply, 0);
          _reply.readException();
        }
        finally {
          _reply.recycle();
    ...
    static final int TRANSACTION_deletedBookLabelUids = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
    static final int TRANSACTION_purgeBookLabels = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
    static final int TRANSACTION_deleteBookLabelByUuid = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
  }
  public static final java.lang.String DESCRIPTOR = "org.geometerplus.android.fbreader.libraryService.LibraryInterface";
  ...
  public java.util.List<java.lang.String> deletedBookLabelUids(int limit, int page) throws android.os.RemoteException;
  public void purgeBookLabels(java.util.List<java.lang.String> uids) throws android.os.RemoteException;
  public void deleteBookLabelByUuid(java.lang.String uuid) throws android.os.RemoteException;
  /** @hide */
