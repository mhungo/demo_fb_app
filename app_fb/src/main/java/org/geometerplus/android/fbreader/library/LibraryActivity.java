...
public class LibraryActivity extends TreeActivity<LibraryTree> implements MenuItem.OnMenuItemClickListener, View.OnCreateContextMenuListener, IBookCollection.Listener<Book> {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		addMenuItem(menu, OptionsItemId.Search, "localSearch", org.fbreader.common.R.drawable.ic_menu_search);
		addMenuItem(menu, OptionsItemId.Rescan, "rescan", org.fbreader.common.R.drawable.ic_menu_refresh);
