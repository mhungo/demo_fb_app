...
public final class BookPopupNightBinding implements ViewBinding {
  @NonNull
  ...
  private BookPopupNightBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static BookPopupNightBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static BookPopupNightBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.book_popup_night, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static BookPopupNightBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new BookPopupNightBinding((LinearLayout) rootView, binding_bookPopupButtons,
          bookPopupCover, bookPopupDescriptionText, bookPopupHeaderText);
    }
